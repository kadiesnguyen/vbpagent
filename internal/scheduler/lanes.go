...
// per-session message queuing for the VBPClaw gateway.
//
...
//
//	VBPCLAW_LANE_MAIN=30
//	VBPCLAW_LANE_SUBAGENT=50
//	VBPCLAW_LANE_TEAM=100
//	VBPCLAW_LANE_CRON=30
func DefaultLanes() []LaneConfig {
	return []LaneConfig{
		{Name: LaneMain, Concurrency: laneEnv("VBPCLAW_LANE_MAIN", 30)},
		{Name: LaneSubagent, Concurrency: laneEnv("VBPCLAW_LANE_SUBAGENT", 50)},
		{Name: LaneTeam, Concurrency: laneEnvFallback("VBPCLAW_LANE_TEAM", "VBPCLAW_LANE_DELEGATE", 100)},
		{Name: LaneCron, Concurrency: laneEnv("VBPCLAW_LANE_CRON", 30)},
	}
}
