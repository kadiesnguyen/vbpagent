...
## Runtime Environment (VBPClaw)

Scripts run inside the VBPClaw container via the `exec` tool. Environment is set by the entrypoint:

| Variable | Value | Purpose |
|----------|-------|---------|
| `PYTHONPATH` | `/app/.vbpclaw/data/.runtime/pip` | Python runtime packages |
| `PIP_TARGET` | `/app/.vbpclaw/data/.runtime/pip` | pip install target |
| `NPM_CONFIG_PREFIX` | `/app/.vbpclaw/data/.runtime/npm-global` | npm global install dir |
