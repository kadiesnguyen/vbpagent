...
func resolveMigrationsDir() string {
	...
	if v := os.Getenv("VBPCLAW_MIGRATIONS_DIR"); v != "" {
		return v
	}
...
func resolveDSN() (string, error) {
	...
	// config.Load also reads VBPCLAW_POSTGRES_DSN into cfg.Database.PostgresDSN.
	...
	if dsn == "" {
		return "", fmt.Errorf("VBPCLAW_POSTGRES_DSN environment variable is not set")
	}
	return dsn, nil
}
