...
import (
	...
	"github.com/kadiesnguyen/vbpclaw/internal/channels/discord"
	"github.com/kadiesnguyen/vbpclaw/internal/channels/feishu"
	slackchannel "github.com/kadiesnguyen/vbpclaw/internal/channels/slack"
	"github.com/kadiesnguyen/vbpclaw/internal/channels/telegram"
	"github.com/kadiesnguyen/vbpclaw/internal/channels/whatsapp"
	"github.com/kadiesnguyen/vbpclaw/internal/channels/zalo"
	zalopersonal "github.com/kadiesnguyen/vbpclaw/internal/channels/zalo/personal"
	...
	"github.com/kadiesnguyen/vbpclaw/internal/heartbeat"
	"github.com/kadiesnguyen/vbpclaw/internal/gateway/methods"
	...
	"github.com/kadiesnguyen/vbpclaw/internal/tasks"
...
func runGateway() {
	...
	// Facebook pages tool (get connected pages)
	toolsReg.Register(tools.NewFacebookPagesTool("http://facebook-oauth:9878"))
	...
	agentsH, skillsH, tracesH, mcpH, channelInstancesH, providersH, builtinToolsH, pendingMessagesH, teamEventsH, secureCLIH, mcpUserCredsH, facebookPageH := wireHTTP(pgStores, cfg.Agents.Defaults.Workspace, dataDir, bundledSkillsDir, msgBus, toolsReg, providerRegistry, permPE.IsOwner, gatewayAddr, mcpToolLister)
	if providersH != nil {
	...
	if facebookPageH != nil {
		server.SetFacebookPageHandler(facebookPageH)
	}
