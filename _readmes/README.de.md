...
<p align="center">
  ...
  <a href="https://docs.vbpclaw.sh/#quick-start">Schnellstart</a> •
...
**VBPClaw** ist ein Multi-Agenten-KI-Gateway, das LLMs mit Ihren Tools, Kanälen und Daten verbindet — als einzelne Go-Binary ohne Laufzeitabhängigkeiten bereitgestellt. Es orchestriert Agenten-Teams und agenten-übergreifende Delegation über 20+ LLM-Anbieter mit vollständiger Mandantenisolierung.
...
make build
./vbpclaw onboard        # Interaktiver Einrichtungsassistent
...
# Mindestens einen VBPCLAW_*_API_KEY in .env hinzufügen, dann:
make up
...
Wenn `VBPCLAW_*_API_KEY`-Umgebungsvariablen gesetzt sind, führt das Gateway das Onboarding automatisch ohne interaktive Eingaben durch — erkennt den Anbieter, führt Migrationen aus und befüllt Standarddaten.

> Für Build-Varianten (OTel, Tailscale, Redis), Docker-Image-Tags und Compose-Overlays, siehe den [Deployment-Leitfaden](https://docs.vbpclaw.sh/#deploy-docker-compose).

## Multi-Agenten-Orchestrierung

VBPClaw unterstützt Agenten-Teams und agenten-übergreifende Delegation — jeder Agent läuft mit seiner eigenen Identität, Tools, LLM-Anbieter und Kontextdateien.
...
> Für Details zu Delegation, Berechtigungslinks und Nebenläufigkeitskontrolle, siehe die [Agenten-Teams-Dokumentation](https://docs.vbpclaw.sh/#teams-what-are-teams).
...
Vollständige Dokumentation unter **[docs.vbpclaw.sh](https://docs.vbpclaw.sh)** — oder den Quellcode unter [`vbpclaw-docs/`](https://github.com/nextlevelbuilder/vbpclaw-docs) durchsuchen.

| Abschnitt | Themen |
|-----------|--------|
| [Erste Schritte](https://docs.vbpclaw.sh/#what-is-vbpclaw) | Installation, Schnellstart, Konfiguration, Web-Dashboard-Tour |
| [Grundkonzepte](https://docs.vbpclaw.sh/#how-vbpclaw-works) | Agenten-Loop, Sitzungen, Tools, Gedächtnis, Mandantenfähigkeit |
| [Agenten](https://docs.vbpclaw.sh/#creating-agents) | Agenten erstellen, Kontextdateien, Persönlichkeit, Teilen & Zugriff |
| [Anbieter](https://docs.vbpclaw.sh/#providers-overview) | Anthropic, OpenAI, OpenRouter, Gemini, DeepSeek, +15 weitere |
| [Kanäle](https://docs.vbpclaw.sh/#channels-overview) | Telegram, Discord, Slack, Feishu, Zalo, WhatsApp, WebSocket |
| [Agenten-Teams](https://docs.vbpclaw.sh/#teams-what-are-teams) | Teams, Aufgaben-Board, Messaging, Delegation & Übergabe |
| [Erweitert](https://docs.vbpclaw.sh/#custom-tools) | Benutzerdefinierte Tools, MCP, Skills, Cron, Sandbox, Hooks, RBAC |
| [Deployment](https://docs.vbpclaw.sh/#deploy-docker-compose) | Docker Compose, Datenbank, Sicherheit, Beobachtbarkeit, Tailscale |
| [Referenz](https://docs.vbpclaw.sh/#cli-commands) | CLI-Befehle, REST-API, WebSocket-Protokoll, Umgebungsvariablen |
...
VBPClaw basiert auf dem ursprünglichen [OpenClaw](https://github.com/openclaw/openclaw)-Projekt. Wir sind dankbar für die Architektur und Vision, die diesen Go-Port inspiriert hat.
