...
<p align="center">
  <a href="https://docs.vbpclaw.sh">Документація</a> •
  <a href="https://docs.vbpclaw.sh/#quick-start">Швидкий старт</a> •
...
**VBPClaw** — це мультиагентний AI-шлюз, що з'єднує LLM з вашими інструментами, каналами та даними — розгортається як єдиний Go-бінарник без зовнішніх залежностей часу виконання. Він оркеструє команди агентів і міжагентну делегацію через 20+ постачальників LLM з повною ізоляцією мультиорендарності.
...
| Функція                    | OpenClaw                             | ZeroClaw                                     | PicoClaw                              | **VBPClaw**                     |
| -------------------------- | ------------------------------------ | -------------------------------------------- | ------------------------------------- | ------------------------------ |
...
make build
./vbpclaw onboard        # Інтерактивний майстер налаштування
...
# Додайте хоча б один VBPCLAW_*_API_KEY до .env, потім:
make up
...
Якщо встановлені змінні середовища `VBPCLAW_*_API_KEY`, шлюз виконує автоматичне налаштування без інтерактивних підказок — визначає постачальника, запускає міграції та заповнює початкові дані.

> Щодо варіантів збірки (OTel, Tailscale, Redis), тегів Docker-образів та compose-оверлеїв, дивіться [Посібник із розгортання](https://docs.vbpclaw.sh/#deploy-docker-compose).

## Мультиагентна оркестрація

VBPClaw підтримує команди агентів та міжагентну делегацію — кожен агент працює зі своєю власною ідентичністю, інструментами, постачальником LLM та файлами контексту.
...
> Щодо деталей делегації, посилань дозволів та керування паралелізмом, дивіться [документацію Команд агентів](https://docs.vbpclaw.sh/#teams-what-are-teams).
...
Повна документація на **[docs.vbpclaw.sh](https://docs.vbpclaw.sh)** — або перегляньте вихідний код у [`vbpclaw-docs/`](https://github.com/nextlevelbuilder/vbpclaw-docs)

| Розділ | Теми |
|--------|------|
| [Початок роботи](https://docs.vbpclaw.sh/#what-is-vbpclaw) | Встановлення, Швидкий старт, Конфігурація, Огляд веб-панелі |
| [Основні концепції](https://docs.vbpclaw.sh/#how-vbpclaw-works) | Цикл агента, Сесії, Інструменти, Пам'ять, Мультиорендарність |
| [Агенти](https://docs.vbpclaw.sh/#creating-agents) | Створення агентів, Файли контексту, Особистість, Спільний доступ |
| [Постачальники](https://docs.vbpclaw.sh/#providers-overview) | Anthropic, OpenAI, OpenRouter, Gemini, DeepSeek, +15 інших |
| [Канали](https://docs.vbpclaw.sh/#channels-overview) | Telegram, Discord, Slack, Feishu, Zalo, WhatsApp, WebSocket |
| [Команди агентів](https://docs.vbpclaw.sh/#teams-what-are-teams) | Команди, Дошка завдань, Обмін повідомленнями, Делегація та передача |
| [Розширено](https://docs.vbpclaw.sh/#custom-tools) | Власні інструменти, MCP, Навички, Cron, Пісочниця, Хуки, RBAC |
| [Розгортання](https://docs.vbpclaw.sh/#deploy-docker-compose) | Docker Compose, База даних, Безпека, Спостережуваність, Tailscale |
| [Довідник](https://docs.vbpclaw.sh/#cli-commands) | Команди CLI, REST API, Протокол WebSocket, Змінні середовища |
...
VBPClaw побудований на основі оригінального проекту [OpenClaw](https://github.com/openclaw/openclaw). Ми вдячні за архітектуру та бачення, що надихнули цей Go-порт.
