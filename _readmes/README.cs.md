...
<p align="center">
  <a href="https://docs.vbpclaw.sh">Dokumentace</a> •
  <a href="https://docs.vbpclaw.sh/#quick-start">Rychlý start</a> •
...
**VBPClaw** je multi-agentní AI gateway, která propojuje LLM s vašimi nástroji, kanály a daty — nasazena jako jediný Go binární soubor bez runtime závislostí. Orchestruje týmy agentů a delegování mezi agenty napříč 20+ poskytovateli LLM s plnou multi-tenant izolací.
...
| Funkce                     | OpenClaw                             | ZeroClaw                                     | PicoClaw                              | **VBPClaw**                     |
| -------------------------- | ------------------------------------ | -------------------------------------------- | ------------------------------------- | ------------------------------ |
...
make build
./vbpclaw onboard        # Interaktivní průvodce nastavením
...
# Přidat alespoň jeden VBPCLAW_*_API_KEY do .env, poté:
make up
...
Pokud jsou nastaveny proměnné prostředí `VBPCLAW_*_API_KEY`, gateway se automaticky inicializuje bez interaktivních výzev — detekuje poskytovatele, spustí migrace a naplní výchozí data.

> Pro varianty sestavení (OTel, Tailscale, Redis), tagy Docker image a překrytí compose viz [Průvodce nasazením](https://docs.vbpclaw.sh/#deploy-docker-compose).

## Multi-agentní orchestrace

VBPClaw podporuje týmy agentů a delegování mezi agenty — každý agent běží s vlastní identitou, nástroji, poskytovatelem LLM a kontextovými soubory.
...
> Podrobnosti o delegování, odkazech oprávnění a řízení souběžnosti viz [dokumentace Týmů agentů](https://docs.vbpclaw.sh/#teams-what-are-teams).
...
Úplná dokumentace na **[docs.vbpclaw.sh](https://docs.vbpclaw.sh)** — nebo procházejte zdroj v [`vbpclaw-docs/`](https://github.com/nextlevelbuilder/vbpclaw-docs)

| Sekce | Témata |
|-------|--------|
| [Začínáme](https://docs.vbpclaw.sh/#what-is-vbpclaw) | Instalace, Rychlý start, Konfigurace, Prohlídka webového dashboardu |
| [Základní koncepty](https://docs.vbpclaw.sh/#how-vbpclaw-works) | Smyčka agenta, Relace, Nástroje, Paměť, Multi-tenancy |
| [Agenti](https://docs.vbpclaw.sh/#creating-agents) | Vytváření agentů, Kontextové soubory, Osobnost, Sdílení a přístup |
| [Poskytovatelé](https://docs.vbpclaw.sh/#providers-overview) | Anthropic, OpenAI, OpenRouter, Gemini, DeepSeek, +15 dalších |
| [Kanály](https://docs.vbpclaw.sh/#channels-overview) | Telegram, Discord, Slack, Feishu, Zalo, WhatsApp, WebSocket |
| [Týmy agentů](https://docs.vbpclaw.sh/#teams-what-are-teams) | Týmy, Nástěnka úkolů, Zasílání zpráv, Delegování a předání |
| [Pokročilé](https://docs.vbpclaw.sh/#custom-tools) | Vlastní nástroje, MCP, Dovednosti, Cron, Sandbox, Háky, RBAC |
| [Nasazení](https://docs.vbpclaw.sh/#deploy-docker-compose) | Docker Compose, Databáze, Bezpečnost, Pozorovatelnost, Tailscale |
| [Reference](https://docs.vbpclaw.sh/#cli-commands) | Příkazy CLI, REST API, WebSocket protokol, Proměnné prostředí |
...
VBPClaw je postaven na původním projektu [OpenClaw](https://github.com/openclaw/openclaw). Jsme vděčni za architekturu a vizi, která inspirovala tento Go port.
