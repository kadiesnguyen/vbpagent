...
<p align="center">
  <a href="https://docs.vbpclaw.sh">เอกสาร</a> •
  <a href="https://docs.vbpclaw.sh/#quick-start">เริ่มต้นอย่างรวดเร็ว</a> •
...
| ฟีเจอร์                    | OpenClaw                             | ZeroClaw                                     | PicoClaw                              | **VBPClaw**                     |
| -------------------------- | ------------------------------------ | -------------------------------------------- | ------------------------------------- | ------------------------------ |
...
make build
./vbpclaw onboard        # ตัวช่วยตั้งค่าแบบ interactive
...
# เพิ่ม VBPCLAW_*_API_KEY อย่างน้อยหนึ่งรายการใน .env จากนั้น:
make up
...
เมื่อตั้งค่า environment variables `VBPCLAW_*_API_KEY` แล้ว gateway จะทำการ onboard อัตโนมัติโดยไม่ต้องป้อนข้อมูลแบบ interactive — ตรวจจับผู้ให้บริการ รัน migrations และสร้างข้อมูลเริ่มต้น

> สำหรับ build variants (OTel, Tailscale, Redis), Docker image tags และ compose overlays ดูที่ [Deployment Guide](https://docs.vbpclaw.sh/#deploy-docker-compose)

## การประสานงาน Multi-Agent

VBPClaw รองรับ agent teams และการส่งต่องานระหว่าง agent — แต่ละ agent ทำงานด้วย identity, เครื่องมือ, ผู้ให้บริการ LLM และไฟล์ context ของตัวเอง
...
> สำหรับรายละเอียดการส่งต่องาน, permission links และการควบคุม concurrency ดูที่ [เอกสาร Agent Teams](https://docs.vbpclaw.sh/#teams-what-are-teams)
...
เอกสารฉบับสมบูรณ์ที่ **[docs.vbpclaw.sh](https://docs.vbpclaw.sh)** — หรือดู source ที่ [`vbpclaw-docs/`](https://github.com/nextlevelbuilder/vbpclaw-docs)

| หัวข้อ | เนื้อหา |
|---------|--------|
| [เริ่มต้นใช้งาน](https://docs.vbpclaw.sh/#what-is-vbpclaw) | การติดตั้ง, เริ่มต้นอย่างรวดเร็ว, การตั้งค่า, ทัวร์ Web Dashboard |
| [แนวคิดหลัก](https://docs.vbpclaw.sh/#how-vbpclaw-works) | Agent Loop, Sessions, เครื่องมือ, Memory, Multi-Tenancy |
| [Agents](https://docs.vbpclaw.sh/#creating-agents) | การสร้าง Agent, ไฟล์ Context, บุคลิกภาพ, การแชร์และการเข้าถึง |
| [Providers](https://docs.vbpclaw.sh/#providers-overview) | Anthropic, OpenAI, OpenRouter, Gemini, DeepSeek, +15 เพิ่มเติม |
| [ช่องทาง](https://docs.vbpclaw.sh/#channels-overview) | Telegram, Discord, Slack, Feishu, Zalo, WhatsApp, WebSocket |
| [Agent Teams](https://docs.vbpclaw.sh/#teams-what-are-teams) | Teams, Task Board, การส่งข้อความ, การส่งต่องานและ Handoff |
| [ขั้นสูง](https://docs.vbpclaw.sh/#custom-tools) | เครื่องมือกำหนดเอง, MCP, Skills, Cron, Sandbox, Hooks, RBAC |
| [การ Deploy](https://docs.vbpclaw.sh/#deploy-docker-compose) | Docker Compose, ฐานข้อมูล, ความปลอดภัย, Observability, Tailscale |
| [อ้างอิง](https://docs.vbpclaw.sh/#cli-commands) | คำสั่ง CLI, REST API, WebSocket Protocol, Environment Variables |
...
VBPClaw สร้างขึ้นจากโครงการ [OpenClaw](https://github.com/openclaw/openclaw) ต้นฉบับ เราขอขอบคุณสถาปัตยกรรมและวิสัยทัศน์ที่เป็นแรงบันดาลใจในการ port มาเป็น Go
