...
<p align="center">
  <a href="https://docs.vbpclaw.sh">Dokumentáció</a> •
  <a href="https://docs.vbpclaw.sh/#quick-start">Gyors kezdés</a> •
...
A **VBPClaw** egy többügynökös AI átjáró, amely összeköti az LLM-eket az eszközeiddel, csatornáiddal és adataiddal — egyetlen Go binárisként telepítve, futásidejű függőségek nélkül. Ügynökcsapatokat és ügynökök közötti delegálást vezényel több mint 20 LLM-szolgáltatón keresztül, teljes többbérlős izolációval.
...
| Funkció                    | OpenClaw                             | ZeroClaw                                     | PicoClaw                              | **VBPClaw**                     |
| -------------------------- | ------------------------------------ | -------------------------------------------- | ------------------------------------- | ------------------------------ |
...
make build
./vbpclaw onboard        # Interaktív telepítő varázsló
...
# Adj meg legalább egy VBPCLAW_*_API_KEY értéket a .env fájlban, majd:
make up
...
Ha a `VBPCLAW_*_API_KEY` környezeti változók be vannak állítva, az átjáró interaktív prompt nélkül automatikusan elvégzi az onboardingot — felismeri a szolgáltatót, futtatja a migrációkat és feltölti az alapértelmezett adatokat.

> A build-változatokért (OTel, Tailscale, Redis), Docker image-címkékért és compose overlay-ekért lásd a [Telepítési útmutatót](https://docs.vbpclaw.sh/#deploy-docker-compose).

## Többügynökös vezénylés

A VBPClaw támogatja az ügynökcsapatokat és az ügynökök közötti delegálást — minden ügynök saját identitással, eszközökkel, LLM-szolgáltatóval és kontextfájlokkal fut.
...
> A delegálás részleteiért, jogosultsági kapcsolatokért és párhuzamossági vezérlésért lásd az [Ügynökcsapatok dokumentációt](https://docs.vbpclaw.sh/#teams-what-are-teams).
...
A teljes dokumentáció elérhető a **[docs.vbpclaw.sh](https://docs.vbpclaw.sh)** oldalon — vagy böngéssz a forrásban itt: [`vbpclaw-docs/`](https://github.com/nextlevelbuilder/vbpclaw-docs)

| Szakasz | Témák |
|---------|--------|
| [Kezdő lépések](https://docs.vbpclaw.sh/#what-is-vbpclaw) | Telepítés, Gyors kezdés, Konfiguráció, Webes irányítópult bemutató |
| [Alapfogalmak](https://docs.vbpclaw.sh/#how-vbpclaw-works) | Ügynök hurok, Munkamenetek, Eszközök, Memória, Többbérlősség |
| [Ügynökök](https://docs.vbpclaw.sh/#creating-agents) | Ügynökök létrehozása, Kontextfájlok, Személyiség, Megosztás és hozzáférés |
| [Szolgáltatók](https://docs.vbpclaw.sh/#providers-overview) | Anthropic, OpenAI, OpenRouter, Gemini, DeepSeek, +15 további |
| [Csatornák](https://docs.vbpclaw.sh/#channels-overview) | Telegram, Discord, Slack, Feishu, Zalo, WhatsApp, WebSocket |
| [Ügynökcsapatok](https://docs.vbpclaw.sh/#teams-what-are-teams) | Csapatok, Feladattábla, Üzenetküldés, Delegálás és átadás |
| [Haladó](https://docs.vbpclaw.sh/#custom-tools) | Egyéni eszközök, MCP, Skillek, Cron, Sandbox, Horgok, RBAC |
| [Telepítés](https://docs.vbpclaw.sh/#deploy-docker-compose) | Docker Compose, Adatbázis, Biztonság, Megfigyelhetőség, Tailscale |
| [Hivatkozás](https://docs.vbpclaw.sh/#cli-commands) | CLI parancsok, REST API, WebSocket protokoll, Környezeti változók |
...
A VBPClaw az eredeti [OpenClaw](https://github.com/openclaw/openclaw) projektre épül. Hálásak vagyunk az architektúráért és a vízióért, amely ezt a Go portot ihlette.
